            ...
            return (
              <li className="py-4 border-b-2 border-indigo-200">
                <div className="flex items-center">
                  ...
                  <label htmlFor="todo1" className="  text-gray-900 flex flex-row justify-around">
                    <span className=" text-blue-400  " ><svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
